...
public class TimerUtils {
    ...
    public static final Log LOG = LogFactory.getLog(TimerUtils.class);
...
//		}
    ...
    public static void log(String confPath) {
        LOG.info("Conf: " + confPath + " ; Time: " + getSecond() + " secconds");
        System.out.println("Conf: " + confPath + " ; Time: " + getSecond() + " secconds");
    }
